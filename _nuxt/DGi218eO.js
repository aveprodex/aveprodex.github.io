 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */,f=(t,r)=>{var e;const a=t._$AN;if(void 0===a)return!1;for(const o of a)null==(e=o._$AO)||e.call(o,r,!1),f(o,r);return!0},S=t=>{let r,e;do{if(void 0===(r=t._$AM))break;e=r._$AN,e.delete(t),t=r}while(0===(null==e?void 0:e.size))},E=t=>{for(let r;r=t._$AM;t=r){let e=r._$AN;if(void 0===e)r._$AN=e=new Set;else if(e.has(t))break;e.add(t),$(r)}};function b(t){void 0!==this._$AN?(S(this),this._$AM=t,E(this)):this._$AM=t}function x(t,r=!1,e=0){const a=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(r)if(Array.isArray(a))for(let i=e;i<a.length;i++)f(a[i],!1),S(a[i]);else null!=a&&(f(a,!1),S(a));else f(this,t)}const $=t=>{t.type==s.CHILD&&(t._$AP??(t._$AP=x),t._$AQ??(t._$AQ=b))};class R extends n{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,r,e){super._$AT(t,r,e),E(this),this.isConnected=t._$AU}_$AO(t,r=!0){var e,a;t!==this.isConnected&&(this.isConnected=t,t?null==(e=this.reconnected)||e.call(this):null==(a=this.disconnected)||a.call(this)),r&&(f(this,t),S(this))}setValue(t){if(void 0===this._$Ct.strings)this._$Ct._$AI(t,this);else{const r=[...this._$Ct._$AH];r[this._$Ci]=t,this._$Ct._$AI(r,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const T=t=>{return!(r=t,null===r||"object"!=typeof r&&"function"!=typeof r||"function"!=typeof t.then);var r},A=1073741823;const k=c(class extends R{constructor(){super(...arguments),this._$Cwt=A,this._$Cbt=[],this._$CK=new j(this),this._$CX=new P}render(...t){return t.find((t=>!T(t)))??o}update(t,r){const e=this._$Cbt;let a=e.length;this._$Cbt=r;const i=this._$CK,n=this._$CX;this.isConnected||this.disconnected();for(let o=0;o<r.length&&!(o>this._$Cwt);o++){const t=r[o];if(!T(t))return this._$Cwt=o,t;o<a&&t===e[o]||(this._$Cwt=A,a=0,Promise.resolve(t).then((async r=>{for(;n.get();)await n.get();const e=i.deref();if(void 0!==e){const a=e._$Cbt.indexOf(t);a>-1&&a<e._$Cwt&&(e._$Cwt=a,e.setValue(r))}})))}return o}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}});const O=new class{constructor(){this.cache=new Map}set(t,r){this.cache.set(t,r)}get(t){return this.cache.get(t)}has(t){return this.cache.has(t)}delete(t){this.cache.delete(t)}clear(){this.cache.clear()}},L=t`
  :host {
    display: flex;
